...
group the output of the UQ process based on the simillarity of the uncertainty?, (\textit{ii}) what is the uncertainty in some spatio-temporal locations not previously analysed?, (\textit{iii}) what is the uncertainty of an specific spatio-temporal region?, (\textit{iv}) how to compare two regions as a function of its uncertainty?, and (\textit{v}) what is the less uncertain model from a set of models?
