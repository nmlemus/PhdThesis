...
\begin{fichacatalografica}
	...
	\hspace{0.5cm} Generalized lambda distribution for uncertainty quantification of large-scale
spatio-temporal models/ \imprimirautor.
	Petrópolis, RJ. : Laboratório Nacional de Computação Científica, 2018.
	
	\hspace{0.5cm} \pageref{LastPage} p. : il. \pagColoridas ; 29 cm.\\
	
	\hspace{0.5cm} Orientador: Fábio André Machado Porto\\
	
	\hspace{0.5cm}
	\parbox[t]{\textwidth}{Tese (Doutorado) – Laboratório Nacional de Computação Científica, 2018.}\\
	
	\hspace{0.5cm}
		1. Big data 
		2. Quantificação de incerteza
		3. Modelos espaço-temporais a grande escala
		I. Porto, Fábio André Machado.
		II. LNCC/MCTI.
		III. Título.
...
\begin{dedicatoria}
   ...
   \textit{ to my children Leandro and Claudia.\\} \vspace*{\fill}
\end{dedicatoria}
% ---
